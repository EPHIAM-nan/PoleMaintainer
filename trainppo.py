...
from agents.ppo import PPOSolver, PPOConfig
...
if __name__ == "__main__":
    ...
    agent = train(num_episodes=750, terminal_penalty=True)
    evaluate(model_path="models/cartpole_ppo.torch", algorithm="ppo", episodes=100, render=False, fps=60)